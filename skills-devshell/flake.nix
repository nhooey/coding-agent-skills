{
  description = "coding-agent-skills dev-shell skills: the skill set installed into the coding-agent-skills dev shell for working on this repo (git/GitHub hygiene plus skillspkgs' authoring combination) — kept in its own sub-flake so its skill-source inputs stay out of the parent's inputs.";
